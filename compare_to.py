...
def compare_to(image_input, proposed_img=None, methods="all",
    ...
    Args:
        image_input: Input noisy image (uint8 or float).
        proposed_img: Optional proposed denoised image for comparison.
        methods: Denoiser methods to run. "all" or list of names.
        plot: Unused flag (kept for API compatibility).
        save: If True, save output images and reports.
    ...
    for method_name, func in methods_to_run:
        ...
        m["ENL"] = plots.compute_enl(res_img, roi)
        ...
        m["EPI"] = plots.compute_epi(noisy_img, res_img)
